          ...
          >
            ...
            <div className="px-6 py-4 space-y-0">
              ...
              <div className="flex gap-4">
                ...
                <div className="pb-6">
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-mono text-red-400">2025 - Benchmark de l'existant</span>
            ...
            <div className="card p-6 hover:-translate-y-1 transition-transform">
              ...
              <div className="mt-4">
                <a
                  ...
                  className="btn bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md inline-flex items-center gap-2 mr-3"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                ...
                <a
                  ...
                  className="btn bg-orange-100 hover:bg-orange-200 text-orange-700 px-4 py-2 rounded-md inline-flex items-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
